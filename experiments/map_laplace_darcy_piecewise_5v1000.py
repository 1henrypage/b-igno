...
# %% [markdown]
# # MAP and Laplace Approximation: Darcy Piecewise {5, 1000}
#
...
for SEED in SEEDS:
    ...
    FIGURE_DIR = Path(f'figures/map_laplace_darcy_piecewise_5v1000/seed_{SEED}')
...
# %%
print_cross_seed_summary("map_laplace", "darcy_piecewise_5v1000")
