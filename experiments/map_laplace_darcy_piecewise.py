...
# %% [markdown]
# # MAP and Laplace Approximation: Darcy Piecewise
#
...
for SEED in SEEDS:
    ...
    FIGURE_DIR = Path(f'figures/map_laplace_darcy_piecewise/seed_{SEED}')
...
# %%
print_cross_seed_summary("map_laplace", "darcy_piecewise")
