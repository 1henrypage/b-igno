...
# %% [markdown]
# # Sensor Count Sweep: Darcy Piecewise {5, 10}
#
...
for SEED in SEEDS:
    ...
    FIGURE_DIR = Path(f'figures/sensor_sweep_darcy_piecewise_5v10/seed{SEED}')
    ...
    plot_sweep_summary_table(sweep_results, labels, title='Darcy Piecewise 5v10 — Sensor Count Sensitivity',
                             use_icorr=True)
...
# %%
results = load_cross_seed_results("sensor_sweep", "darcy_piecewise_5v10")
