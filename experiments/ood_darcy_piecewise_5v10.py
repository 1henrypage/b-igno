...
# %% [markdown]
# # Out-of-Distribution Robustness: Darcy Piecewise {5, 10}
#
...
IN_DATA_PATH = '../data/darcy_piecewise_5v10/pwc_test_in.mat'
OOD_DATA_PATH = '../data/darcy_piecewise_5v10/pwc_test_out.mat'
...
PROBLEM_NAME = 'ood_darcy_piecewise_5v10'
...
for SEED in SEEDS:
    ...
    plot_metrics_comparison_table_4way(
        ...
        title=f'Darcy Piecewise 5v10 — sigma={SIGMA}, rho_pde={BEST_RHO_PDE} (seed={SEED})',
    )
    ...
    }, title=f'Darcy Piecewise 5v10 — RQ3: Pairwise Contrasts (Bootstrap, seed={SEED})')
    ...
    }, title=f'Darcy Piecewise 5v10 — Physics Benefit Analysis (seed={SEED})')
...
# %%
print_cross_seed_summary("ood", "darcy_piecewise_5v10")
