...
# %% [markdown]
# # MAP and Laplace Approximation: Darcy Piecewise {5, 100}
#
...
for SEED in SEEDS:
    ...
    FIGURE_DIR = Path(f'figures/map_laplace_darcy_piecewise_5v100/seed_{SEED}')
    ...
    la_pw = compute_piecewise_metrics(la_a_samples_np, la_a_true_np, problem.K_LOW, problem.K_HIGH,
                                      a_err_fn=lambda pred, true: cross_correlation(pred, true, k_low=problem.K_LOW, k_high=problem.K_HIGH))
...
# %%
print_cross_seed_summary("map_laplace", "darcy_piecewise_5v100")
